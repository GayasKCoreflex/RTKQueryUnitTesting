...
import performanceLogger from './services/middleware/performanceLogger'
...
export const store = configureStore({
  ...
  middleware: getDefaultMiddleware => getDefaultMiddleware().concat(logger,performanceLogger)
})
